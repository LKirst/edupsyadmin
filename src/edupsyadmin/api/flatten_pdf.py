...
This module provides utilities to flatten PDF forms.
"""
...
from edupsyadmin.api.flattening import flatten_with_pypdf
...
def flatten_pdfs(
    ...
    for fn_in in form_paths:
        try:
            output_path = flatten_pdf(fn_in, output_prefix)
...
def main() -> None:
    ...
    flatten_pdfs(args.inpaths, args.prefix)
